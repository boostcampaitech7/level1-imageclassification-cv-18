...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_name', type=str, default='resnet18', help='model/timm_model_name.txt 에서 확인, 아키텍처 확인은 "https://github.com/huggingface/pytorch-image-models/tree/main/timm/models"')
    ...
    # 하이퍼파라미터
    parser.add_argument('--epochs', type=int, default=3, help='에포크 설정')
