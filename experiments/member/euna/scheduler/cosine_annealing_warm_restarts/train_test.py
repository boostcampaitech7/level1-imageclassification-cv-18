...
if __name__ == "__main__":
    ...
    parser.add_argument('--T_0', type=int, default=10, help='첫 번째 Warm Restart가 발생하기까지의 에포크 수')
    parser.add_argument('--T_mult', type=int, default=1, help='첫 번째 주기 T_0 이후의 각 주기마다 주기 길이를 배수로 늘리기 위한 계수')
