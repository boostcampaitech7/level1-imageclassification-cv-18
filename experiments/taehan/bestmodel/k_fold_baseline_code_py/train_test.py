...
def train_test():
    ...
    for fold in range(k_folds):
        ...
        print("-------")
        model.load_state_dict(torch.load(os.path.join("./test_model_weight/", f'{fold}_bestmodel.pt')))
        print(model)
        # 모델로 추론 실행
...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_rootpath', type=str, default="Experiments/eva_large", help='가중치, log, tensorboard 그래프 저장을 위한 path 실험명으로 디렉토리 구성')
