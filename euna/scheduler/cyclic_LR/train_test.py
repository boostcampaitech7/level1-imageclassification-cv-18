...
if __name__ == "__main__":
    ...
    parser.add_argument('--max_lr', type=float, default=1e-2, help='최대 학습률')
    parser.add_argument('--step_size_up', type=int, default=2000, help='학습률이 최대값에 도달할 때까지의 스텝 수')
    parser.add_argument('--mode', type=str, default='triangular', help='mode 선택 -> 마크다운에 설명 있음')
    parser.add_argument('--cycle_momentum', type=bool, default=False, help=' Adam에서는 모멘텀 사용하지 않음 -> False')
